...
export default function CoverImage({ bookId, title, className }: CoverImageProps) {
  // Use the generated cover set image for all books
  const coverSrc = '/assets/generated/cover-set-01.dim_600x900.png';
